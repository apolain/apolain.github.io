    ...
    document.getElementById(id).innerHTML = data
      .map(
        ...
        <ul class='publications_footer'>
          ${publication.link &&
          `<li>
                <a href=${publication.link} target="_blank"> ${lang === "en" ? "View" : " مشاهده"
          } </a>
              </li>`
          }
            ${publication.github &&
          `<li>
                  <a href=${publication.github} target="_blank">  ${lang === "en" ? "Github" : "گیت‌هاب"
          }</a>
                </li>`
          }
        ...
        (job) =>
          `<div class='job_item'>
            <div class='job_header'>
              ...
              <div>
                <span>${job.startData} - ${job.endDate ? job.endDate : lang === "en" ? "Now" : " تاکنون "
          }</span>
