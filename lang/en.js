  ...
  items: [
    {
      ...
      location: "Paris",
      abstract:
        "Since November 2021, I have been working as a quantitative consultant and PhD candidate under a joint academic–industrial framework. My doctoral research focuses on numerical methods for stochastic control, while my professional work involves quantitative model development, review, and implementation in the banking industry. I have contributed to projects in interest rate risk management and in counterparty credit risk (CCR/XVA), gaining practical experience in model design, implementation, and integration within large-scale risk systems. My responsibilities have included the design of a Python library for asset–liability management models, project coordination and refactoring of quantitative tools, and the implementation of pricing and risk analytics with both modeling and software components.",
